...
public class MainPanel extends Panel implements Runnable{
    ...
    private void newBall() {
        ...
        ball = new Ball(Constants.Screen_Width/2 - 9,random.nextInt(Constants.screen_Height-Constants.ball_size), Constants.ball_size, Constants.ball_size, color);
    }

    private Color getColor(int range){
        Random random = new Random();
        int r = random.nextInt(range);
        int g = random.nextInt(range);
    ...
    private void newPaddle() {
        ...
        p1 = new Paddle(0,(Constants.screen_Height-Constants.paddle_Height)/2,1,color);
        p2 = new Paddle(Constants.Screen_Width-Constants.paddle_Width,(Constants.screen_Height-Constants.paddle_Height)/2,2,color2);
    }
    @Override
    ...
    public void run() {
        ...
        double delta = 0;
        while (Score.player1 <= Constants.win_Score && Score.player2 <= Constants.win_Score){
